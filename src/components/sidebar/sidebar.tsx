...
export default function Sidebar() {
  ...
  return (
    <nav
      className={`sidebar sticky top-0 hidden min-h-screen flex-col overflow-hidden border-r bg-blueNavy py-4 text-white transition-all duration-150 md:flex ${SidebarOpen ? "open" : "closed"}`}
    >
      <div className="mb-4 flex justify-center">
        <Link href={"/admin/dashboard"}>
          {contentOpen ? (
            ...
            <Image
              src="https://assets.loket.com/images/favicon/favicon.ico"
              alt="Loket"
              className="bg-white"
              width={30}
              height={30}
